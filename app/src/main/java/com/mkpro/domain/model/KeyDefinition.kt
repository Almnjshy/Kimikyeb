...
data class KeyDefinition(
    ...
    companion object {
        ...
        val BACKSLASH = KeyDefinition("backslash", "\\", KeyType.CHARACTER, '\\', weight = 1.5f, shiftLabel = "|", shiftCharacter = '|')
        val SEMICOLON = KeyDefinition(";", ";", KeyType.CHARACTER, ';', weight = 1.0f, shiftLabel = ":", shiftCharacter = ':')
        val APOSTROPHE = KeyDefinition("apostrophe", "'", KeyType.CHARACTER, '\'', weight = 1.0f, shiftLabel = "\"", shiftCharacter = '"')
        ...
        val SHIFT = KeyDefinition("shift", "Shift", KeyType.MODIFIER, keyCode = android.view.KeyEvent.KEYCODE_SHIFT_LEFT, weight = 1.5f)
        val SHIFT_RIGHT = KeyDefinition("shift_right", "Shift", KeyType.MODIFIER, keyCode = android.view.KeyEvent.KEYCODE_SHIFT_RIGHT, weight = 1.5f)
        ...
        val BACKSPACE = KeyDefinition("backspace", "Del", KeyType.ACTION, keyCode = android.view.KeyEvent.KEYCODE_DEL, weight = 1.5f, isRepeatable = true)
        val ENTER = KeyDefinition("enter", "Enter", KeyType.ACTION, keyCode = android.view.KeyEvent.KEYCODE_ENTER, weight = 1.5f)
        ...
        val ARROW_UP = KeyDefinition("arrow_up", "Up", KeyType.NAVIGATION, keyCode = android.view.KeyEvent.KEYCODE_DPAD_UP, weight = 1.0f)
        val ARROW_DOWN = KeyDefinition("arrow_down", "Down", KeyType.NAVIGATION, keyCode = android.view.KeyEvent.KEYCODE_DPAD_DOWN, weight = 1.0f)
        val ARROW_LEFT = KeyDefinition("arrow_left", "Left", KeyType.NAVIGATION, keyCode = android.view.KeyEvent.KEYCODE_DPAD_LEFT, weight = 1.0f)
        val ARROW_RIGHT = KeyDefinition("arrow_right", "Right", KeyType.NAVIGATION, keyCode = android.view.KeyEvent.KEYCODE_DPAD_RIGHT, weight = 1.0f)
        ...
        val EMOJI = KeyDefinition("emoji", "Emoji", KeyType.SPECIAL, weight = 1.0f)
        val LANGUAGE = KeyDefinition("language", "Lang", KeyType.SPECIAL, weight = 1.0f)
        ...
        val SETTINGS = KeyDefinition("settings", "Set", KeyType.SPECIAL, weight = 1.0f)
    }
}
